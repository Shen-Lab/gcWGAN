...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/CriticLoss_Critic.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/NonsenseSequenceRatio_Critic_Train.eps')
...
plt.ylabel('Nonsense Sequence Ratio')
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/NonsenseSequenceRatio_Critic_New.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/SequenceIdentity_Critic.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/PaddingRatio_Critic.eps')
