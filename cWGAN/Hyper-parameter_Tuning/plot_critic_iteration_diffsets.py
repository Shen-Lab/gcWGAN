...
# tune the critic iteration number..
# 11/21/2019
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/CriticLoss_Critic_' + set_kind + '.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/NonsenseSequenceRatio_Critic_' + set_kind + '.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/SequenceIdentity_Critic_' + set_kind + '.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/PaddingRatio_Critic_' + set_kind + '.eps')
