...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/CriticLoss_NoiseLength_' + set_kind + '.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/NonsenseSequenceRatio_NoiseLength_' + set_kind + '.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/SequenceIdentity_NoiseLength_' + set_kind + '.eps')
...
plt.legend()
plt.savefig('cWGAN_Validation_Results/cWGAN_Validation_Images/PaddingRatio_NoiseLength_' + set_kind + '.eps')
