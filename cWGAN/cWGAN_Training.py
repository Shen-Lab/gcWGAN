...
fold_len = 20 #MK add
name = '_' + lr + '_' + str(CRITIC_ITERS) + '_' + str(noise_len)

check_path = '../Checkpoints/cWGAN/model'+name 
sample_path = 'cWGAN_Training_Samples/TrainingSamples'+name
...
plt.savefig('Images/Critic_Loss'+name+'.png')
plt.figure(2) #SZ add
plt.plot(G_cost) #SZ add
plt.title("Generator Loss Function")
plt.xlabel("Iteration Number")
plt.ylabel("Generator Loss")
plt.savefig('Images/Generator_Loss'+name+'.png')
plt.show() #SZ ad
"""
