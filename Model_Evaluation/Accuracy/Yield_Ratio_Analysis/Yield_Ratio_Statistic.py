...
YieldRatio_Dict_train = {'a':[],'b':[],'c':[],'d':[],'e':[],'f':[],'g':[],'easy':[],'median':[],'hard':[]}
YieldRatio_Dict_vali = {'a':[],'b':[],'c':[],'d':[],'e':[],'f':[],'g':[],'easy':[],'median':[],'hard':[]}
YieldRatio_Dict_test = {'a':[],'b':[],'c':[],'d':[],'e':[],'f':[],'g':[],'easy':[],'median':[],'hard':[]}
...
for cl in YieldRatio_Dict_train.keys():
...
for cl in YieldRatio_Dict_test.keys():
