        ...
        if V_SIZE > 0: 
            ...
            for p in range(V_SIZE):
                ...
                if FOLD in f_pre:
                    ...
                    num += 1
                    s_file = open('Pipeline_Sample/Generating_Ratio_Samples/' + KIND + '_Sample_Fasta_time_' + FOLD + '_' + str(GEN_NUM),'a')
                    stat_file = open('Pipeline_Sample/Generating_Ratio_Samples/' + KIND + '_Stat_time_' + FOLD + '_' + str(GEN_NUM),'a')
