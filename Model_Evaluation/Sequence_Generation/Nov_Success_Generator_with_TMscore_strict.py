...
s_file = open('Pipeline_Sample/' + KIND + '_Fasta_' + str(GEN_NUM) + '_success_' + fold_name + '_with_TMscore_strict','w')
s_file.close()
    ...
    while(num < GEN_NUM):
        ...
        for p in range(V_SIZE):
            ...
            if 'a.30' in f_pre:
                ...
                num += 1
                s_file = open('Pipeline_Sample/' + KIND + '_Fasta_' + str(GEN_NUM) + '_success_' + fold_name + '_with_TMscore_strict','a')
                sequ = ''.join(test_se[p])
