...
all_file = open('Pipeline_Sample/cVAE_all_backup_' + str(GEN_NUM) + '_' + fold_name,'w')
success_file = open('Pipeline_Sample/cVAE_Fasta_' + str(GEN_NUM) + '_success_' + fold_name,'w')
all_file.close()
success_file.close()
...
while(s_index < GEN_NUM):
    ...
    if V_SIZE > 0: 
        ...
        all_file = open('Pipeline_Sample/cVAE_all_backup_' + str(GEN_NUM) + '_' + fold_name,'a')
        success_file = open('Pipeline_Sample/cVAE_Fasta_' + str(GEN_NUM) + '_success_' + fold_name,'a')
