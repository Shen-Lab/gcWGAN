...
if sys.argv[-1] == 'no_label':
    Weight_list = sys.argv[2:-1]
    whether_label = False
    label_notation = '_no_label'
else:
    Weight_list = sys.argv[2:]
    whether_label = True
    label_notation = ''
...
for weight in Weight_list:
    ...
    loss_file = open('Converge_Check_Result/loss_0.0001_5_64_' + str(float(weight)) + '_semi_diff','r')
