...
for i in range(num):
    ...
    nr = DL.file_list('gcWGAN_Validation_Results/gcWGAN_' + index + set_kind + '_Nonsense_Ratio.fa')
...
plt.legend()
plt.savefig('gcWGAN_Validation_Results/gcWGAN_Validation_Images/NonsenseSequenceRatio_' + set_kind + '.eps')
