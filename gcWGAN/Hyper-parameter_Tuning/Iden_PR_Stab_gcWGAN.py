...
with tf.Session() as session:
    ...
    file_i = open('gcWGAN_Validation_Results/Identity_' + test_index + '_' + fold_set,'w')
    file_pad = open('gcWGAN_Validation_Results/Padding_Ratio_' + test_index + '_' + fold_set,'w')
    file_stab = open('gcWGAN_Validation_Results/Stability_' + test_index + '_' + fold_set,'w')
    file_i.close()
    file_pad.close()
    file_stab.close()
    ...
    for c in Check_selected:
        ...
        file_i = open('gcWGAN_Validation_Results/Identity_' + test_index + '_' + fold_set,'a')
        file_pad = open('gcWGAN_Validation_Results/Padding_Ratio_' + test_index + '_' + fold_set,'a')
        file_stab = open('gcWGAN_Validation_Results/Stability_' + test_index + '_' + fold_set,'a')
        ...
        file_pad.write('\n')
        file_stab.write(str(mean_stability))
        file_stab.write('\n')
        file_i.close()
        file_pad.close()
        file_stab.close()
