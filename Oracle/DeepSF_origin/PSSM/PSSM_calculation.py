...
command += ' -out ' + PSSM_psi_path + SEQ_name + '.out'
command += ' -num_threads 4 -comp_based_stats 1 -evalue 0.001 -db nr' + database + '/nr' + database + ' -num_iterations 1' 
command += ' -out_ascii_pssm ' + PSSM_psi_path + SEQ_name + '_pssm -save_pssm_after_last_round'
os.system(command)
...
pssm_file = open(PSSM_psi_path + SEQ_name + '_pssm','r')
...
pssm_deepsf_1 = open(PSSM_deepsf_path + SEQ_name + '.pssm_fea','w')
...
#pssm_deepsf_2 = open(PSSM_deepsf_path + SEQ_name + '_2.pssm_fea','w')
...
PSSM_stat_file = open(PSSM_stat_path + SEQ_name + '_stat','w')
